...
public class Exemplo2 {
    ...
    public void rodarExemplo() throws InterruptedException {

        System.out.println("Escolha onde quer colocar o alimento, os dois robos nos pontos 0,0 e 5,5 tentarao chegar la sozinhos.");
